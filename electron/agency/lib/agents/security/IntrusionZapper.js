 ...
 *           to protect the internal SOVRA_APEX MANNIX brain.
 */
export class IntrusionZapper {
    ...
    async evaluateZap(ip, payload) {
        ...
        const isHostile = payloadStr.includes('admin') ||
        ...
        if (isHostile) {
            ...
            if (count >= 3) {
                ...
                await CoreDB.logAgentActivity('IntrusionZapper', `HARD BLOCK: IP ${ip} zapped for hostile payload.`, 'FAILED');
