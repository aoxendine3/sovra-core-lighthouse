    ...
    <main className="min-h-screen bg-[#050505] text-white font-sans p-8 md:p-32 overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-32">
          {[{"name":"Private Jet Travel Concierge Service","description":"Exclusively curated private jet travel experiences tailored to individual preferences and schedules, complete with personalized concierge services and bespoke itineraries.","price":"$15,000,000","keywords":"private jet travel, luxury experience, exclusive service"},{"name":"Customized Luxury Yacht Charter","description":"Private yacht charter with tailored amenities and activities designed specifically for high-net-worth individuals seeking unparalleled oceanic experiences.","price":"$20,000,000","keywords":"luxury yacht, private charter, exclusive sailing"},{"name":"Personalized High-End Private Villa Rentals","description":"VIP access to the world's most luxurious villas, curated specifically for high-net-worth individuals seeking unparalleled privacy and exclusivity in prime locations.","price":"$12,000,000","keywords":"luxury villa rentals, private retreats, exclusive living"}].map((p: any, i: number) => (
