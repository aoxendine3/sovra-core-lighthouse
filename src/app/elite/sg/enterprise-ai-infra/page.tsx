    ...
    <main className="min-h-screen bg-[#050505] text-white font-sans p-8 md:p-32 overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-32">
          {[{"name":"Aurora AI Platform","description":"Exclusive, bespoke AI platform for the world's most influential institutions, empowering cutting-edge innovation and strategic decision-making.","price":"$20,000,000","keywords":"AI platform, enterprise AI, institutional solutions, APAC, Singapore"},{"name":"Apex Neuro Network","description":"High-performance, cloud-native neural network infrastructure for the most discerning organizations, accelerating breakthrough research and innovation.","price":"$15,000,000","keywords":"neural networks, AI infrastructure, enterprise solutions, APAC, Singapore"},{"name":"Paragon AI Governance","description":"Comprehensive, AI-driven governance platform for the world's most sophisticated institutions, ensuring regulatory compliance, risk management, and optimal ROI.","price":"$12,000,000","keywords":"AI governance, enterprise AI, institutional solutions, APAC, Singapore"}].map((p: any, i: number) => (
