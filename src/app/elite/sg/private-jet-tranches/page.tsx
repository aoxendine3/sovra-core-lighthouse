    ...
    <main className="min-h-screen bg-[#050505] text-white font-sans p-8 md:p-32 overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-32">
          {[{"name":"Aurora Private Aviation Experience","description":"Exclusive access to bespoke flight planning, personalized in-flight entertainment, and tailored airport concierge services for the discerning traveler.","price":"$25,000,000","keywords":"private jet experience, bespoke travel, luxury aviation"},{"name":"SkyPilot Elite Flight Program","description":"Personalized flight training and mentoring from experienced pilots, customized aircraft maintenance support, and priority access to rare aircraft models.","price":"$15,000,000","keywords":"private jet ownership, pilot training, exclusive aviation"},{"name":"Astral Estates Private Airfield Ownership","description":"Private airfield ownership with luxury hangar facilities, personal ground handling, and dedicated security services for the ultimate in private aviation luxury.","price":"$30,000,000","keywords":"private airfield ownership, luxury real estate, bespoke aviation"}].map((p: any, i: number) => (
