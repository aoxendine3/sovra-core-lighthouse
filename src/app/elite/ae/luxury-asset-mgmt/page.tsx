    ...
    <main className="min-h-screen bg-[#050505] text-white font-sans p-8 md:p-32 overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-32">
          {[{"name":"Nexus Genesis","description":"Expertly curated investment portfolio tailored to individualized goals, leveraging cutting-edge ESG research and bespoke asset allocation.","price":"$15,000,000","keywords":"Luxury Investment Management, High Net Worth Individuals, UAE"},{"name":"Privée Asset Solutions","description":"Discretionary wealth management for high-net-worth families, offering a bespoke approach to asset allocation, tax planning, and philanthropic strategies.","price":"$12,500,000","keywords":"Private Wealth Management, Luxury Family Office, UAE"},{"name":"Crescendo Impact","description":"Impact investing strategy for high-net-worth individuals, focusing on socially responsible investments with the potential to generate both financial returns and positive societal impact.","price":"$18,000,000","keywords":"Sustainable Investing, Luxury Impact Investing, UAE"}].map((p: any, i: number) => (
