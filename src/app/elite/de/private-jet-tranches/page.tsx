    ...
    <main className="min-h-screen bg-[#050505] text-white font-sans p-8 md:p-32 overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-32">
          {[{"name":"Aurum Concierge","description":"Exclusive access to bespoke private jet travel experiences, tailored to individual preferences and schedules.","price":"$125,000","keywords":"private jet concierge, luxury travel, bespoke experience"},{"name":"SkyPrix Elite","description":"Ultra-luxurious private jet ownership program offering personalized service, priority access, and exclusive benefits for the ultra-high net worth individual.","price":"$150,000","keywords":"private jet ownership, luxury aviation, high net worth"},{"name":"Velvet Wings Club","description":"Privileged membership in an exclusive private jet network, granting access to rare aircraft, VIP lounges, and personalized travel planning.","price":"$20,000 (annual dues)","keywords":"private jet club, luxury air travel, privileged membership"}].map((p: any, i: number) => (
