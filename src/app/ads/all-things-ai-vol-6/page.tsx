...
export const metadata = {
  title: 'SOVRA Institutional Briefing: All Things AI: Vol 6',
  description: 'Absolute operational deployment briefing for All Things AI: Vol 6.'
};
      ...
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <main className="relative">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="glass-panel p-2 rounded-[40px] border border-white/10 bg-white/[0.03] overflow-hidden shadow-2xl">
                 <img 
                    src="/assets/ata_hero.png" 
                    alt="All Things AI" 
                    className="w-full h-full object-cover rounded-[32px]"
                 />
              </div>

              <div className="glass-panel p-10 rounded-[50px] border border-white/5 bg-white/[0.02] shadow-2xl relative z-10 backdrop-blur-xl">
                 <div className="flex items-center gap-4 mb-8 opacity-60">
                    <Globe className="w-5 h-5 text-cyan-500" />
                    <span className="text-xs font-mono tracking-widest uppercase">Global Market Saturation Active</span>
                 </div>
                 
                 <div className="prose prose-invert prose-p:text-lg prose-p:leading-relaxed prose-p:text-white/80 max-w-none">
                    <p>Detailed breakdown and synthesis of the latest AI breakthroughs, Volume 6.</p>
                 ...
                 <div className="mt-12 flex flex-col items-start gap-8">
                    <a 
                       href="https://sovra-15.myshopify.com/products/all-things-ai-vol-6"
                       className="group relative px-12 py-5 rounded-2xl bg-white text-black font-black uppercase tracking-[0.2em] hover:bg-cyan-400 transition-all shadow-[0_0_80px_rgba(255,255,255,0.1)] overflow-hidden"
                    >
