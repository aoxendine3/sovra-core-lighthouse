...
export const metadata = {
  title: 'SOVRA Institutional Briefing: SOVRA_DEEP_LOCK_V1_CORE',
  description: 'Absolute operational deployment briefing for SOVRA_DEEP_LOCK_V1_CORE.'
};
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <main className="glass-panel p-10 rounded-[40px] border border-white/5 bg-white/[0.01] shadow-2xl relative overflow-hidden">
           ...
           <div className="mt-12 flex flex-col items-center">
              <a 
                href={`/api/track?target=${encodeURIComponent('https://gumroad.com/l/deep-lock-core')}&handshake=APEX&category=AD_SATURATION`}
