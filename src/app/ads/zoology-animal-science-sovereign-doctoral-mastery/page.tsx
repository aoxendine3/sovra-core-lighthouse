...
export const metadata = {
  title: 'SOVRA Institutional Briefing: Zoology & Animal Science: Sovereign Doctoral Mastery',
  description: 'Absolute operational deployment briefing for Zoology & Animal Science: Sovereign Doctoral Mastery.'
};
      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <header className="space-y-4">
           ...
           <h1 className="text-6xl font-black tracking-tighter uppercase italic text-transparent bg-clip-text bg-gradient-to-br from-white to-white/40">
              Zoology & Animal Science: Sovereign Doctoral Mastery
           </h1>
        </header>
        ...
        <main className="glass-panel p-10 rounded-[40px] border border-white/5 bg-white/[0.01] shadow-2xl relative overflow-hidden">
           ...
           <div className="mt-12 flex flex-col items-center">
              <a 
                href={`/api/track?target=${encodeURIComponent('https://gumroad.com/l/sovra-doc-700')}&handshake=APEX&category=AD_SATURATION`}
