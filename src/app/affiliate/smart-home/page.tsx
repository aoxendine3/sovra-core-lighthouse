...
export const metadata: Metadata = {
  title: 'Top smart home Gadgets 2026',
  description: 'Curated list of the best and highest converting smart home products.',
};
    ...
    <main style={{ background: '#0a0a0f', color: '#fff', minHeight: '100vh', padding: '60px 24px', fontFamily: "'Inter', sans-serif" }}>
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        <h1 style={{ fontSize: '3rem', fontWeight: 800, marginBottom: 16 }}>
          Trending <span style={{ color: '#a78bfa' }}>smart home</span> Picks
        </h1>
          ...
          {products.map((product: any, idx: number) => (
            <div key={idx} style={{ background: 'rgba(255,255,255,0.05)', borderRadius: 16, padding: 24, border: '1px solid rgba(255,255,255,0.1)' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <a 
                  href={`/api/track?url=${encodeURIComponent(`https://www.amazon.com/s?k=${encodeURIComponent(product.keywords)}&tag=SOVRA_APEXpettech20-20`)}&source=smart-home_PAGE`} 
                  target="_blank"
