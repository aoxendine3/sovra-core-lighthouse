...
export const metadata: Metadata = {
  title: 'Institutionell pet tech | SOVRA Sovereign LLC',
...
const products = [
  {
    "name": "Pet-Tracker mit GPS und Bluetooth",
    "description": "Führe deinen Haustier auf eine spannende Reise mit unserem Pet-Tracker mit GPS und Bluetooth, der dich immer in Sicherheit wissen lässt.",
    "price": "$99.99",
    "keywords": "Haustierspurrer,GPS-Tracker"
  }
];

export default function pettechDEPage() {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        <header className="text-center mb-24 space-y-8">
          ...
          <h1 className="text-8xl md:text-9xl font-black italic tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40">
            Institutionell <br/><span className="text-gradient-cyan">PET TECH</span>
          </h1>
