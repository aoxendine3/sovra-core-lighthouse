...
export const metadata: Metadata = {
  title: 'Institutionell smart home | SOVRA Sovereign LLC',
  description: 'Global Germany & DACH tech tranche. Strategische Hardware-Tranchen mit hohem Ertrag. Gesichert über den Sovereign Node.',
};

const products = [
  {
    "name": "Philips Hue Smart Light Bulbs",
    "description": "Energieeffiziente und steuerbare Lichtbulben für eine intelligente Heimat.",
    "price": "$49.99",
    "keywords": "huhtuv smart home luzen"
  },
  {
    "name": "August Smart Locks",
    "description": "Sichere und komfortable Zugang zu Ihrer Wohnung mit August Smart Locks.",
    "price": "$149.99",
    "keywords": "august smart home sicherheit"
  },
  {
    "name": "Amazon Echo Dot (4th Gen)",
    "description": "Ein intelligenter Sprachassistent für Ihre Heimat mit Amazon Alexa.",
    "price": "$49,99",
    "keywords": "amazon echo dot 4. veranstaltung"
  },
  {
    "name": "Nest Learning Thermostat",
    "description": "Erfahren Sie die Intelligenz von Nest und optimieren Sie Ihre Heizung für eine kostengünstige Wärme.",
    "price": "$249,99",
    "keywords": "nest lernende thermostat"
  },
  {
    "name": "Ring Video Doorbell Pro",
    "description": "Sichere Überwachung Ihrer Wohnung mit Ring Video Doorbell Pro und einer 1080p-Bildqualität.",
    "price": "$149,99",
    "keywords": "ring video doorbell pro"
  }
];

export default function smarthomeDEPage() {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        <header className="text-center mb-24 space-y-8">
          ...
          <h1 className="text-8xl md:text-9xl font-black italic tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40">
            Institutionell <br/><span className="text-gradient-cyan">SMART HOME</span>
          </h1>
          <p className="text-white/40 text-xl max-w-2xl mx-auto font-light leading-relaxed italic">
            Strategische Hardware-Tranchen mit hohem Ertrag. Gesichert über den Sovereign Node.
          </p>
        </header>
