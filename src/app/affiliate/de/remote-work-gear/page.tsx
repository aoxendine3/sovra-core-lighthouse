...
export const metadata: Metadata = {
  title: 'Institutionell remote work gear | SOVRA Sovereign LLC',
...
const products = [
  {
    "name": "Remotefreier Laptop-Decken für die Arbeit zu Hause oder im Büro",
    "description": "Professionelle, atmungsaktive und hygienische Lungenmasken zur Reduzierung von Schmutzpartikeln während der Nutzung Ihres Laptops",
    "price": "$12.99",
    "keywords": "laptop-lungenschutz"
  }
];

export default function remoteworkgearDEPage() {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        <header className="text-center mb-24 space-y-8">
          ...
          <h1 className="text-8xl md:text-9xl font-black italic tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40">
            Institutionell <br/><span className="text-gradient-cyan">REMOTE WORK GEAR</span>
          </h1>
