...
export const metadata: Metadata = {
  title: 'Institutional remote work gear | SOVRA Sovereign LLC',
...
const products = [
  {
    ...
    "description": "Expand your laptop's ports with this compact and reliable USB-C hub.",
    "price": "$29.99",
    "keywords": "usb-c hub,laptop accessories"
  }
];

export default function remoteworkgearENPage() {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        <header className="text-center mb-24 space-y-8">
          ...
          <h1 className="text-8xl md:text-9xl font-black italic tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40">
            Institutional <br/><span className="text-gradient-cyan">REMOTE WORK GEAR</span>
          </h1>
