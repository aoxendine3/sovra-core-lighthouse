...
export const metadata: Metadata = {
  title: 'Institutional pet tech | SOVRA Sovereign LLC',
...
const products = [
  {
    "name": "Pet Grooming Robot",
    "description": "Automatically trims and grooms your dog with ease.",
    "price": "$299.99",
    "keywords": "pet grooming robot"
  }
];

export default function pettechENPage() {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        <header className="text-center mb-24 space-y-8">
          ...
          <h1 className="text-8xl md:text-9xl font-black italic tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40">
            Institutional <br/><span className="text-gradient-cyan">PET TECH</span>
          </h1>
