...
export default function HubSpotVsEnchargePage() {
  return (
      ...
      <main style={{ maxWidth: 1000, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(340px, 1fr))', gap: 32, marginBottom: 80 }}>
          ...
          <div style={{ padding: 48, borderRadius: 32, background: 'rgba(0,240,255,0.03)', border: '1px solid rgba(0,240,255,0.2)', backdropFilter: 'blur(20px)', position: 'relative', overflow: 'hidden' }}>
            ...
            <p style={{ color: '#fff', lineHeight: 1.6 }}>Encharge offers AI-driven behavioral automation, faster integration with 500+ tools via Zapier, and competitive pricing for high-growth SaaS businesses, outpacing HubSpot's complexity.</p>
          </div>
        </div>
