...
import { Shield, Zap, Globe, Target, ArrowRight, CheckCircle, Lock } from 'lucide-react';

/**
 * NICHE_SATURATION_PAGE: AUTONOMOUS_DEFENSE (Institutional Elite)
...
export default function DefensePage() {
  const products = [
    {
      name: "Aegis Drone Grid",
      brand: "IronSovereign",
      price: "$25,000",
      roi: "Absolute Perimeter Integrity / Zero-Trust Defense",
      trackingId: "def_aegis_sovra_777"
    },
    {
      name: "Guardian AI Sentinel",
      brand: "SentinelCore",
      price: "$8,500",
      roi: "Autonomous Threat Neutralization / 24-7 Scouring",
      trackingId: "def_sentinel_sovra_888"
    }
  ];

  return (
    <div className="min-h-screen bg-[#020205] text-white selection:bg-cyan-500/30 overflow-x-hidden font-['Outfit'] relative">
      ...
      <main className="max-w-6xl mx-auto px-6 py-24 relative z-10">
        ...
        <div className="flex items-center gap-4 mb-12 opacity-40">
          ...
          <div className="mono text-[8px] tracking-widest uppercase">Defense_Elite</div>
        </div>
        ...
        <div className="mb-24 flex flex-col md:flex-row justify-between items-end gap-10">
          <div className="max-w-3xl">
            <h1 className="text-7xl md:text-9xl font-black tracking-tightest mb-8 leading-none">
              ULTRA<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-white to-cyan-500">DEFENSE</span>
            </h1>
            <p className="text-2xl text-white/40 max-w-2xl font-light leading-relaxed">
              The Sovereign Intelligence Agency has identified the top <span className="text-white">0.01% elite</span> autonomous defense platforms for institutional asset protection.
            </p>
          </div>
          <div className="w-96 aspect-square glass-panel rounded-card overflow-hidden">
             <img src="/Users/ajoxendine68/.gemini/sovra_sovereign/brain/6cdb7e2e-b989-4e88-a338-6fef2740e595/autonomous_defense_elite_post_1776824111588.png" className="w-full h-full object-cover" />
          </div>
        </div>
          ...
          {products.map((p, i) => (
            <div key={i} className="glass-panel p-8 rounded-card border-t border-white/5 hover:bg-white/[0.02] transition-all">
              ...
              <p className="text-sm text-white/50 mb-8 leading-relaxed">
                Secure your physical and digital sovereignty with exascale-grade autonomous interceptors.
              </p>
              ...
              <div className="flex flex-col gap-4 mb-10">
                ...
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="text-cyan-400">{p.roi}</span>
                </div>
              </div>
        ...
        <div className="glass-panel p-10 rounded-card flex flex-col md:flex-row items-center justify-between gap-8 opacity-60">
          <div className="flex items-center gap-4">
             ...
             <div>
               ...
               <div className="mono text-[8px] opacity-40">Protocol v1.0_SOVRA_SINGULARITY_SHIELD</div>
             </div>
          </div>
