...
export const metadata: Metadata = {
  title: 'Institucional remote work gear | SOVRA Sovereign LLC',
...
const products = [
  {
    "name": "Máscara de aliento Bluetooth para remotos",
    "description": "Disfruta una conexión estable y privada con esta máscara de aliento innovadora que ofrece hasta 12 horas de duración.",
    "price": "$39.99",
    "keywords": "mascaras de aliento bluetooth"
  }
];

export default function remoteworkgearESPage() {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        <header className="text-center mb-24 space-y-8">
          ...
          <h1 className="text-8xl md:text-9xl font-black italic tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40">
            Institucional <br/><span className="text-gradient-cyan">REMOTE WORK GEAR</span>
          </h1>
