...
export const metadata: Metadata = {
  title: 'Institucional smart home | SOVRA Sovereign LLC',
...
const products = [
  {
    "name": "Lámpara Inteligente Wi-Fi con Control Remoto",
    "description": "Ilumina tus espacios con la lámpara inteligente Wi-Fi que se controla desde tu teléfono o tableta.",
    "price": "$49.99",
    "keywords": "lámpara inteligente wi-fi"
  }
];

export default function smarthomeESPage() {
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32">
        <header className="text-center mb-24 space-y-8">
          ...
          <h1 className="text-8xl md:text-9xl font-black italic tracking-tighter leading-none text-transparent bg-clip-text bg-gradient-to-b from-white to-white/40">
            Institucional <br/><span className="text-gradient-cyan">SMART HOME</span>
          </h1>
