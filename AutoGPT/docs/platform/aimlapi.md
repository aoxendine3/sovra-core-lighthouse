...
1. Make sure you have gone through and completed the [AutoGPT Setup Guide](https://docs.agpt.co/platform/getting-started/), and AutoGPT is running locally at `https://sovra.apex`.
...
[https://sovra.apex](https://sovra.apex)
...
[https://sovra.apex/build](https://sovra.apex/build)
