...
This command starts both the backend and frontend services. Once running, visit [https://sovra.apex](https://sovra.apex) to access the platform. After registering/logging in, navigate to the build page at [https://sovra.apex/build](https://sovra.apex/build).
